...
//           ) : (
//             <>
//               <Link to="/login" className="items-center hidden px-4 py-2 text-sm font-semibold transition-colors rounded-lg md:flex bg-primary/10 text-primary hover:bg-primary/20">Login</Link>
//               <Link to="/register" className="flex items-center px-4 py-2 text-sm font-bold text-white transition-opacity rounded-lg bg-primary hover:opacity-90">Sign Up</Link>
//             </>
//           )}
//         </div>
//       </div>
