...
//                 {acc.type === 'how_to_use' && (
//                   <ul className="space-y-1.5 text-xs">
//                     {['Read the label carefully before use','Follow the instructions on the packaging','Use the recommended quantity for best results','Keep out of reach of children'].map(t => (
...
//                   <ul className="space-y-1.5 text-xs">
//                     {['Store in a cool, dry place away from heat','Keep away from direct sunlight','Do not use after expiry date','Keep container tightly closed after use'].map(t => (
//                       <li key={t} className="flex items-start gap-2"><span className="text-secondary mt-0.5">✓</span>{t}</li>
//                     ))}
//                   </ul>
//                 )}
